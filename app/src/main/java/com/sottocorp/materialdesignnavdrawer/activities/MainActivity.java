...
import com.sottocorp.materialdesignnavdrawer.fragments.HomeFragment;
import com.sottocorp.materialdesignnavdrawer.fragments.MaestrasFragment;
import com.sottocorp.materialdesignnavdrawer.fragments.MapFragment;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private FrameLayout mFrameLayout_AccountView, mFrameLayout_Home,
            mFrameLayout_Map, mFrameLayout_HelpAndFeedback, mFrameLayout_About, mFrameLayout_obrasmaestras;
    ...
    private void initialise() {
        ...
        mFrameLayout_Map = (FrameLayout) findViewById(R.id.navigation_drawer_items_list_linearLayout_explore);
        mFrameLayout_obrasmaestras = (FrameLayout) findViewById(R.id.navigation_drawer_items_list_linearLayout_obrasmaestras);
        ...
        mFrameLayout_Map.setOnClickListener(this);
        mFrameLayout_obrasmaestras.setOnClickListener(this);
        ...
        if (view == mFrameLayout_AccountView) {
            ...
            if (!view.isSelected()) {
                ...
                if (view == mFrameLayout_Home) {
                    ...
                    getSupportFragmentManager()
                            .beginTransaction()
                            .replace(R.id.main_activity_content_frame, MapFragment.newInstance(bundle))
                            .commit();
                } else if (view == mFrameLayout_obrasmaestras) {

                    if (getSupportActionBar() != null) {
                        getSupportActionBar().setTitle("Obras Maestras");
                    }
                    ...
                    getSupportFragmentManager()
                            .beginTransaction()
                            .replace(R.id.main_activity_content_frame, MaestrasFragment.newInstance(bundle))
                            .commit();
    ...
    private void setUpIcons() {
        // Icons tint list
        final ImageView homeImageView = (ImageView) findViewById(R.id.navigation_drawer_items_list_icon_home);
        ...
        final ImageView exploreImageView = (ImageView) findViewById(R.id.navigation_drawer_items_list_icon_explore);
        ...
        final ImageView maestrasImageView = (ImageView) findViewById(R.id.navigation_drawer_items_list_icon_obrasmaestras);
        final Drawable maestrasDrawable = DrawableCompat.wrap(maestrasImageView.getDrawable());
        DrawableCompat.setTintList(
                maestrasDrawable.mutate(),
                ContextCompat.getColorStateList(this, R.color.nav_drawer_row_icon)
        );
        maestrasImageView.setImageDrawable(maestrasDrawable);
